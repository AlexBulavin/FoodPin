...
class RecipesTableViewController: UITableViewController {
    ...
    /* name: "",
     ...
     recipeRating: "*")*/
    var recipes:[Recipes] = [
        Recipes(name: "Сырники из творога",
